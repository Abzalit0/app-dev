...
;$(document).ready(function () {
  $(".header-content__backgraund-list").slick({
    slidesToShow: 1,
    slidesToScroll: 1,
    autoplay: true,
    autoplaySpeed: 3000,
